...
export function MetadataPanel({
  ...
  return (
    <div className="flex flex-col gap-5 p-5">
      ...
      <Field label="Cover image" hint="Arrives with media storage (R2)">
        <div className="flex aspect-video items-center justify-center rounded-md border border-dashed border-border bg-muted/40 text-center text-xs text-muted-foreground">
          Coming soon
        </div>
      </Field>
